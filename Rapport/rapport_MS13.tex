...
\end{equation} 
Et par construction, $\mathbb{C}$ est bien symétrique, comme annoncé. La matrice $\mathbb{C}$ est appelé \textit{Matrice de corrélation}, terminologie issue 
...
maillage. Pour résoudre le problème pour un nouveau $\mu$, on se place simplement dans la base réduite $P$ :
\[
